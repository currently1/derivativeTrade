...
void TraderQtApp::initConf(){
	...
	this->ui.strategyProductTableView->setColumnWidth(4,200);
	this->ui.strategyProductTableView->setColumnWidth(5,200);
...
//	this->m_strategyProductModel->setSourceModel(this->strategyManager->createModel());
	...
	this->ui.positionListTableView->setColumnWidth(0,190);
